...
def main():
    ...
    # Compute
    result_part1 = my_computation(races_times, races_distances)
    print("MAIN: result of part1 is:", result_part1)
...
def sandbox():
    ...
    # Compute
    result_part1 = my_computation(races_times, races_record_distances)
    print("SANDBOX: result of part1 is:", result_part1)
