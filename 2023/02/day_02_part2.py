...
for game in games:
    ...
    # Initialize the lowest number of cubes needed for each color    
    min_number_of_cubes_blue = 0
    min_number_of_cubes_green = 0
    min_number_of_cubes_red = 0
        ...
        for color_index, color_content in enumerate(colors):
            ...
            match color_of_cubes.strip():
                case 'blue':
                    ...
                    if number_of_cubes > min_number_of_cubes_blue:
                        min_number_of_cubes_blue = number_of_cubes
                case 'green':
                    if number_of_cubes > maximum_number_of_cubes_green:
                        color_possible = False
                        subset_possible = False
                        print(color_of_cubes, "is impossible")
                    if number_of_cubes > min_number_of_cubes_green:
                        min_number_of_cubes_green = number_of_cubes
                case 'red':
                    if number_of_cubes > maximum_number_of_cubes_red:
                        color_possible = False
                        subset_possible = False
                        print(color_of_cubes, "is impossible")
                    if number_of_cubes > min_number_of_cubes_red:
                        min_number_of_cubes_red = number_of_cubes
                case _:
    ...
    if game_possible == True:
        ...
        exit()
    print("For this game:")
    print("Fewest number of blues", min_number_of_cubes_blue)
    print("Fewest number of greens", min_number_of_cubes_green)
    print("Fewest number of reds", min_number_of_cubes_red)
    power_of_the_set_of_cubes = min_number_of_cubes_blue * min_number_of_cubes_green * min_number_of_cubes_red
    print("The power of the set of cubes is", power_of_the_set_of_cubes)
    cumulative_power = cumulative_power + power_of_the_set_of_cubes
...
print("cumulative power of the sets is:", cumulative_power)
