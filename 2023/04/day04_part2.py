...
def prepare_and_process_data(input_list:list):
    ...
    for line_index, line_content in enumerate(input_list):
        ...
        print("copies_of_cards as first encountered by card:", card_index, "before doing anything related to part2 is:", copies_of_cards)
        ...
        # As many times as there are copies of this card
        for i in range(copies_of_cards[0]):
            # As deep as number of matching numbers are in this card
            for j in range(number_of_price_numbers_in_card):
                copies_of_cards[j+1] = copies_of_cards[j+1] + 1
        ...
        print("list of card copies after adding number of price numbers in card, as many times as copies are of this card:", card_index, "is:", copies_of_cards)
        ...
        # Add the individual card scoring
